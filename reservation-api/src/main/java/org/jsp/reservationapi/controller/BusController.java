...
public class BusController {
	...
	@GetMapping("/find-by-loc/{from_loc}/{to_loc}")
	public ResponseEntity<ResponseStructure<List<Bus>>> findByFrom_locAndTo_loc(@PathVariable String from_loc,@PathVariable String to_loc) {
			
		return busService.findByFrom_locAndTo_loc(from_loc, to_loc);
	}
	...
	@GetMapping("/find")
	public ResponseEntity<ResponseStructure<List<Bus>>> findBuses(@RequestParam String from, @RequestParam String to, @RequestParam LocalDate dod) {
		return busService.findBuses(from, to, dod);
	}
